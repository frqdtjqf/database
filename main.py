...
from backend.lego_db.write_lego_data import build_tables_from_json, write_model_list_to_db
from backend.lego_db.read_lego_data import read_models_from_table
from backend.sql_api import DataBaseWrapper
from backend.lego_db.constants import TABLES
...
build_tables_from_json(db, TABLES)
